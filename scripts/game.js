...
var Game = function (_Phaser$Game) {
  ...
  function Game() {
    ...
    var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, 350, 600, Phaser.AUTO, 'game', null));

    _this.state.add('boot', _BootState2.default, false);
...
},{"states/BootState":15,"states/GameState":16,"states/LoadingState":17,"states/MenuState":18,"states/SplashState":19}],3:[function(require,module,exports){
'use strict';
...
var InstructionEnemy = exports.InstructionEnemy = function (_Enemy) {
  ...
  function InstructionEnemy() {
    ...
    return _possibleConstructorReturn(this, (InstructionEnemy.__proto__ || Object.getPrototypeOf(InstructionEnemy)).apply(this, arguments));
  }

  _createClass(InstructionEnemy, [{
    key: 'create',
    value: function create() {
      _get(InstructionEnemy.prototype.__proto__ || Object.getPrototypeOf(InstructionEnemy.prototype), 'create', this).call(this);
    ...
    key: 'update',
    value: function update() {
      _get(InstructionEnemy.prototype.__proto__ || Object.getPrototypeOf(InstructionEnemy.prototype), 'update', this).call(this);
...
var ConsoleEnemy = exports.ConsoleEnemy = function (_Enemy2) {
  ...
  function ConsoleEnemy() {
    ...
    return _possibleConstructorReturn(this, (ConsoleEnemy.__proto__ || Object.getPrototypeOf(ConsoleEnemy)).apply(this, arguments));
  }

  _createClass(ConsoleEnemy, [{
    key: 'create',
    value: function create() {
      _get(ConsoleEnemy.prototype.__proto__ || Object.getPrototypeOf(ConsoleEnemy.prototype), 'create', this).call(this);
...
var GitEnemy = exports.GitEnemy = function (_ConsoleEnemy) {
  ...
  function GitEnemy() {
    ...
    return _possibleConstructorReturn(this, (GitEnemy.__proto__ || Object.getPrototypeOf(GitEnemy)).apply(this, arguments));
  }
  ...
  _createClass(GitEnemy, [{
    ...
    value: function create() {
      ...
      _get(GitEnemy.prototype.__proto__ || Object.getPrototypeOf(GitEnemy.prototype), 'create', this).call(this);
...
var EnemySpawner = function () {
  ...
  _createClass(EnemySpawner, [{
    ...
    value: function spawnEnemyAt(x, y, text) {
      var typeConstr = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : _Enemy.ConsoleEnemy;
...
var Background = function () {
  function Background(game) {
    var minTime = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 4000;
    var maxTime = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 7000;
...
},{"util/GradientBackground":20}],9:[function(require,module,exports){
'use strict';
  ...
  _createClass(GameStateButtons, [{
    ...
    value: function create(_ref, context) {
      var resumeCallback = _ref.resumeCallback,
          pauseCallback = _ref.pauseCallback,
          replayCallback = _ref.replayCallback,
          menuCallback = _ref.menuCallback,
          musicCallback = _ref.musicCallback;
    ...
    value: function createGameOverModal(_ref2, context) {
      var resumeCallback = _ref2.resumeCallback,
          replayCallback = _ref2.replayCallback,
          menuCallback = _ref2.menuCallback;
    ...
    value: function createGamePausedModal(_ref3, context) {
      var resumeCallback = _ref3.resumeCallback,
          replayCallback = _ref3.replayCallback,
          menuCallback = _ref3.menuCallback;
    ...
    value: function createEndGameModal(_ref4, context) {
      var resumeCallback = _ref4.resumeCallback,
          replayCallback = _ref4.replayCallback,
          menuCallback = _ref4.menuCallback;
...
var InstructionsSpawner = function (_WaveSpawner) {
  ...
  function InstructionsSpawner(wave, level, spawner) {
    ...
    return _possibleConstructorReturn(this, (InstructionsSpawner.__proto__ || Object.getPrototypeOf(InstructionsSpawner)).call(this, wave, level, spawner));
  }
  ...
  _createClass(InstructionsSpawner, [{
    ...
    value: function spawn() {
      ...
      enemy.create();
      _get(InstructionsSpawner.prototype.__proto__ || Object.getPrototypeOf(InstructionsSpawner.prototype), 'spawn', this).call(this);
    }
  }, {
    key: 'totalEnemies',
    get: function get() {
...
var ConsoleSpawner = function (_WaveSpawner2) {
  ...
  function ConsoleSpawner(wave, level, spawner) {
    ...
    var _this2 = _possibleConstructorReturn(this, (ConsoleSpawner.__proto__ || Object.getPrototypeOf(ConsoleSpawner)).call(this, wave, level, spawner));
  ...
  _createClass(ConsoleSpawner, [{
    ...
    value: function start() {
      ...
      if (!!git && !this.hasSpawnedGitEnemy && this.progressConsoleOnly >= git.atProgress) {
        ...
        var enemy = this.spawn(_Enemy.GitEnemy);
    ...
    key: 'spawn',
    value: function spawn() {
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _Enemy.ConsoleEnemy;
      ...
      _get(ConsoleSpawner.prototype.__proto__ || Object.getPrototypeOf(ConsoleSpawner.prototype), 'spawn', this).call(this);
...
var LevelSpawner = function (_EnemySpawner) {
  ...
  function LevelSpawner(game, state) {
    ...
    var _this3 = _possibleConstructorReturn(this, (LevelSpawner.__proto__ || Object.getPrototypeOf(LevelSpawner)).call(this, game, state));

    _this3.levels = _levels2.default;
    _this3.currentLevelIndex = 0;
    _this3._totalEnemies = [];
    _this3.state.onDestroyingProgress.add(_this3.enemyWasDestroyed, _this3);
    return _this3;
  }
  ...
  _createClass(LevelSpawner, [{
    ...
    value: function start() {
      ...
      this.waves = this.levels[this.currentLevelIndex].waves.map(function (wave) {
        ...
        return new waveSpawner(wave, _this4.currentLevel, _this4);
      });
    ...
    key: 'nextLevel',
    value: function nextLevel() {
      _get(LevelSpawner.prototype.__proto__ || Object.getPrototypeOf(LevelSpawner.prototype), 'nextLevel', this).call(this);
...
var RandomSpawner = function (_EnemySpawner) {
  ...
  function RandomSpawner() {
    ...
    return _possibleConstructorReturn(this, (RandomSpawner.__proto__ || Object.getPrototypeOf(RandomSpawner)).apply(this, arguments));
  }
  ...
  _createClass(RandomSpawner, [{
    ...
    key: 'nextLevel',
    value: function nextLevel() {
      _get(RandomSpawner.prototype.__proto__ || Object.getPrototypeOf(RandomSpawner.prototype), 'nextLevel', this).call(this);
      this.start();
    }
  }]);
...
var Torpedo = function () {
  ...
  _createClass(Torpedo, [{
    key: 'create',
    value: function create() {
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'torpedo';
...
},{"util/rand":22}],15:[function(require,module,exports){
'use strict';
...
},{"gkui/gkui":1,"objects/Enemy":6,"objects/GameBackground":8,"objects/GameStateHUD":9,"objects/KrakenPlayer":10,"objects/LevelSpawner":11,"objects/RandomSpawner":13,"objects/Torpedo":14}],17:[function(require,module,exports){
'use strict';
...
},{"objects/BigKraken":5}],19:[function(require,module,exports){
'use strict';
...
},{"objects/LogoBall":12,"util/TweenParams":21}],20:[function(require,module,exports){
'use strict';
...
var GradientBackground = function () {
  ...
  _createClass(GradientBackground, [{
    ...
    value: function create(width, height) {
      var colors = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [{ value: 'white', position: 0 }];
